		...
		<TestComponentStyling>
			<div className="relative w-full px-4 py-20 mx-auto lg:w-3/5">
				<div className="flex flex-wrap items-start mainContent gap-y-6">
					<article className="relative w-full px-4 active bg-green-dark md:w-1/2">
						<div className="relative z-10 px-8 pt-16 pb-20 leading-4 border border-black md:px-12 2xl:px-8 border-opacity-10 rounded-3xl">
							<div>
								<div className="relative inline-flex items-center justify-center w-12 h-12 mb-8 leading-6 text-white rounded-full bg-green-default">
								...
								<Paragraph
									...
									tailwindStyling="mt-8 font-[400] text-darkGrey text-base text-left leading-normal"
								/>
							</div>
						</div>
					</article>
