					...
					<div className="flex flex-col items-center justify-center mx-auto md:max-w-max">
						...
						>
							<Link
								...
								className="flex flex-row px-6 py-4 leading-4 text-white transition-all duration-500 ease-in-out rounded-lg lg:py-6 lg:px-20 bg-green-default hover:bg-goldPrimeDarker"
							>
								<svg
